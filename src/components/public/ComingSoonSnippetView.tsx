...
export interface ComingSoonSnippetViewProps {
  ...
  /** Form styles for form shortcode. */
 ...
 */
export function ComingSoonSnippetView({ content, buttonStyles, formStyles, themeColors }: ComingSoonSnippetViewProps) {
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 text-center [&_.prose]:mx-auto [&_.prose]:text-left [&_.prose_a]:underline [&_.prose_img]:rounded-lg">
      <PublicContentRenderer content={content} buttonStyles={buttonStyles} formStyles={formStyles} themeColors={themeColors} />
    </div>
  );
}
