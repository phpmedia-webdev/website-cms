...
export function CodeSnippetsListClient() {
  ...
  const fetchItems = async () => {
    ...
    try {
      ...
      console.error("Fetch code snippets:", e);
      setItems([]);
    } finally {
      setLoading(false);
    }
    ...
    <Card>
      <CardHeader>
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Button asChild>
            <Link href="/admin/super/code-snippets/new">
                      ...
                      <tr key={c.id} className="border-t hover:bg-accent">
                        ...
                        <td className="px-3 py-1.5 text-right">
                          <Button variant="ghost" size="sm" asChild>
                            <Link href={`/admin/super/code-snippets/${c.id}`}>
