...
export function CodeSnippetFormClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/admin/super/code-snippets/${created.id}`);
    } catch (e) {
      console.error("Create snippet:", e);
      alert(e instanceof Error ? e.message : "Failed to create snippet");
    } finally {
      setSaving(false);
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" variant="outline" asChild>
                <Link href="/admin/super/code-snippets">Cancel</Link>
              </Button>
            </div>
          </form>
        </CardContent>
