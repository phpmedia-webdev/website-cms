 ...
 * Ensures handle exists, creates standalone support_ticket task (no required project),
 * adds the contact as creator follower. Returns { taskId }.
 */
