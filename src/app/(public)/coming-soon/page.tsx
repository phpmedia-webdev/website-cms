...
import { getComingSoonCopy, getButtonStyles, getFormStyles, getDesignSystemConfig } from "@/lib/supabase/settings";
...
export default async function ComingSoonPage() {
  ...
  return (
    ...
    >
      ...
      {snippetContent ? (
        <ComingSoonSnippetView content={snippetContent} buttonStyles={buttonStyles} formStyles={formStyles} themeColors={config.colors} />
      ) : (
