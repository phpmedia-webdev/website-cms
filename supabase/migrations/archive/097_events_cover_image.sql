-- File: 097_events_cover_image.sql
-- Add optional cover_image_id to events. Update RPCs to return it.
-- Run in Supabase SQL Editor.

SET search_path TO website_cms_template_dev, public;

-- Add column (media table in same schema)
...
-- Update get_events_dynamic to include cover_image_id
...
-- Update get_event_by_id_dynamic to include cover_image_id
