-- File: 198_get_tasks_dynamic_preset_filters.sql
--
-- =============================================================================
-- MANUAL SQL (this repo): copy entire file → Supabase Dashboard → SQL Editor → Run.
-- Extends get_tasks_dynamic for All Tasks §1.3 presets: exclude_status_slugs, due_before.
-- =============================================================================
--
-- exclude_status_slugs: omit tasks whose task_status_slug matches any listed slug (e.g. completed).
-- due_before: omit tasks with null due_date; keep only rows where due_date < due_before (exclusive).
